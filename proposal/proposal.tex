...
%---- BOX 1 ------------------------------------------------------------
%
% You should use this template for period 97A applications ONLY.
%
...
\Title{A kickass title is required for this program}

% Type below the numeric code corresponding to the subcategory of your
% programme.

\SubCategoryCode{D2} % Post-main-sequence stars, giants, supergiants, AGB stars, post-AGB stars
...
\Abstract{The bulge and disc contain the most stellar tracers in the Milky Way and therefore host the most information content about the Galaxy's formation and evolution. However, ineffective photometric selections result in studies that are heavily contaminated by nearby, uninformative dwarfs. We propose a pilot program to obtain narrow-band ($\sim$510~nm) imaging across $NNN$~deg$^2$ in the bulge. When these data are combined with public ESO/VPHAS $g$- and ESO/VISTA $K$-band imaging, we can select FGK red giant branch (RGB) stars with just 1\% contamination (compared to $\sim$30\%) and $\sim$90\% completeness. Mid-infrared colours linearly correlate with metallicity in RGB stars, allowing precise estimates of stellar parameters directly from photometry. These observations will enable the most efficient search for Population III stars, permit inferences on the evolution of the Galaxy, and provide incredible legacy value for future spectroscopic surveys in the Milky Way plane.
}
...
\ObservingRun{A}{97}{FORS2}{4h}{may}{n}{0.8}{PHO}{s}{}
\ObservingRun{A/alt}{97}{FORS2}{3n=2x1+2H2}{may}{n}{0.8}{PHO}{v}{}
\ObservingRun{B}{97}{VIMOS}{2n=2x1}{jun}{n}{0.6}{CLR}{v}{}
\ObservingRun{C}{97}{EFOSC2}{3n}{aug}{n}{0.8}{THN}{v}{}
\ObservingRun{D}{97}{NACO}{0.4n}{may}{n}{0.8}{THN}{v}{}
\ObservingRun{E}{97}{VIMOS}{1h}{apr}{n}{1.4}{THN}{s}{}
\ObservingRun{F}{97}{VIMOS}{1h}{apr}{n}{n}{THN}{s}{}
...
\ScientificRationale{
The bulge and disc contain the most populous stellar tracers of the Milky Way and therefore host the most information content about the Galaxy's formation and evolution. For this reason numerous spectroscopic studies have sought to survey red giant branch (RGB) stars the plane of Milky Way. These observations are challenging: stellar crowding, strong absolute and differential extinction, and inefficient photometric target selection of giants result in contamination by a large fraction ($\sim$40\%) of dwarf stars. If the stellar parameters ($\boldsymbol{\theta} = \{T_{\rm eff}$, $\log{g}$, ${\rm [Fe/H]}\}$) of RGB stars could be estimated directly from photometry, this would highlight rare objects (e.g., extremely metal-poor or Population III stars), in addition to permitting high-level inferences about the chemical evolution of the Milky Way. This proposal highlights a novel photometric selection which boasts the most efficient selection of RGB stars known, and permits predictions of stellar parameters of RGB stars with high-fidelity directly from photometry. Our photometric selection is missing one filter, which is only available through ESO. We seek to observe the Milky Way bulge in narrow-band imaging and leverage existing ESO data to efficiently select RGB stars, predict their stellar parameters directly from photometry, enabling unprecedented scientific inferences and discoveries and providing incredible legacy value for future spectroscopic surveys.

We utilise data from the \textit{Kepler} field to demonstrate the efficiency and effectiveness of our proposed observations. The \textit{Kepler} field has been extensively imaged in multiple filters (broad- and narrow-band), and numerous spectroscopic studies have reported stellar parameters and detailed chemical abundances. One crucial imaging filter used was the narrow-band $DDO_{51}$ filter centered at $\sim$510~nm (Giesler, 1984). This filter covers the MgH molecular feature (present in dwarfs) and the strong Mg I b triplet lines. The Mg triplet lines saturate quickly, producing absorption profiles with extensive wings caused by pressure broadening. Because the broad-band $g-$filter peaks near the same central wavelength as $DDO_{51}$ (Fig. 1), the $g-DDO_{51}$ colour is extremely sensitive to photospheric pressure and surface gravity $\log{g}$ for FGK stars, with little dependence on spectral type. This is clearly demonstrated in Fig. 2, where a simple colour cut in $g-K_s$ (a $T_{\rm eff}$ proxy) and $g - DDO_{51}$ (green area) yields a robust selection of giant stars ($\sim$90\% completeness) with extremely low contamination by dwarfs ($\sim$1\%). This simple colour cut implies an easily-invertible selection function, a critical component for any large-scale surveys seeking to compare data to models of the Milky Way. 

% Giants are sensitive to metallicity
Our photometrically-selected giant stars have infrared colours that are sensitive to metallicity (Kennedy \& Wyatt?? 2013, Schlaufman \& Casey 2014, Casey \& Schlaufman 2015).

Thus, using a relatively simple set of photometric bands ($g$, $K$, $W_{1}$, $W_{2}$, and $DDO_{51}$) we can efficiently select RGB stars and probabilistically estimate their stellar parameters $p\left(\boldsymbol{\theta}|g,K_s,DDO_{51},W_1-W_2\right)$ based on existing Kepler data.

% Expected problems with extinction

% What can be done when we have these data.
The ability to efficiently select RGB stars in the plane and precisely estimate their stellar parameters enables a wealth of scientific inferences and discoveries. Here we briefly describe some immediate scientific programmes that motivate our imaging program.

\textbf{1. Population III stars} formed in the earliest period of the Universe from pristine metal-free gas. Because galaxies form from the inside-out, most Population III stars are expected to reside in the bulge. However, stellar crowding and extinction have forced surveys to focus on the halo. Despite decades of searching in the halo, no Population III stars have been found. Extinction

\textbf{2. Undiscovered metal-poor clusters}

\textbf{3. The chemical and structural evolution of the Milky Way bulge}

\textbf{4. Bulge/bar interface}

In addition to the straightforward aforementioned scientific discoveries, our program adds incredible \textbf{legacy value} to the existing catalog of ESO imaging data in the plane.

% EMP stars
% Undiscovered metal-poor clusters in MW
% Chemical evolution studies.
% Bulge/bar interface studies
% Legacy for future spectroscopic studies that plan to target RGB stars in bulge.

}
  

\MakePicture{filter-response.pdf}{width=5cm}
\MakeCaption{Fig.~1: A caption for your figure can be inserted here.}
  
\MakePicture{giant-selection.pdf}{width=5cm}
\MakeCaption{Fig.~2: A caption for your figure can be inserted here.}

\MakePicture{wise-metallicity.pdf}{width=5cm}
\MakeCaption{Fig.~3: A caption for your figure can be inserted here.}

\MakePicture{vphas-g.pdf}{width=10cm}
\MakeCaption{Fig.~4: A caption for your figure can be inserted here.}
...
\ImmediateObjective{Immediate objective of the proposal: state what is
  ...
  The ESO archives contain deep photometry for the bulge and plane in $g$-, $K$- through the VPHAS and VISTA programmes, respectively. The WISE point spread function is too large to be useful in crowded regions of the bulge, but the $IRAC_{1}$ and $IRAC_{2}$ channels in public GLIMPSE data are well-matched to the $W_1$, $W_2$ passbands. Thus, the only 
  
  
  } 

% Existing ESO imaging exists for g, K, etc.
% The only remaining filter imaging required to enable this vast scientific potential is the DDO51-like imaging.
% We propose a pilot survey to observe the bulge region in this filter and cross-match
% against existing survey.
% Produce a merged catalogue of VPHAS g, VISTA k, DDO51, GLIMPSE IRAC 1 and 2, yielding a powerful dataset with impressive legacy value.
...
\WhyLunarPhase{This programme uses WFI filter 871 with a central wavelength of 520~nm, and aims to reach $V \sim 20$ to match the existing ESO/VPHAS programme on OmegaCam. The WFI filter 871 is also known to cause ghost images. Thus, we require dark time for these faint blue observations.}
...
\TelescopeJustification{The remaining two $DDO_{51}$ filters are both in the northern hemisphere. Neither filter is of the right size to be installed on any comparable southern telescopes (e.g., OmegaCam, SkyMapper, CTIO). \textbf{ESO's Wide Field Imager on the MPG 2.2m telescope is the only southern facility in the world with a filter sufficiently comparable to $\bm{DDO_{51}}$.}}
...
\RequestedDataRemark{No, there is no imaging of any kind in the bulge or plane using filter 871 with the Wide Field Imager (or the comparable 862 or 875 filters).}
...
The ESO/VPHAS programme is observing the bulge and plane in $u$, $g$, $r$, $H\alpha$, and i-band. The discrimination between FGK dwarf and giant stars comes from the $g - F_{871}$ colour, where $F_{871}$ is the gravity-sensitive 871 filter centered at 520~nm. We plan to make use of existing ESO/VPHAS $g$-band photometry and ESO/VISTA??? $K$-band photometry in the plane.

%We will use public GLIMPSE data from the \textit{Spitzer} space telescope instead of the 
% VST is covering this in JHK?
}
...
\Publications{
Howes, L., Casey, A.~R., et al., 2015, Nature, accepted: \textit{Extremely Metal-Poor Stars in the Milky Way Bulge from the Cosmic Dawn}\\
Casey, A.~R., \& Schlaufman, K.~C., 2015, ApJ, 809, 110: \textit{Chemistry of the Most Metal-poor Stars in the Bulge and the $z \gtrsim 10$ Universe}\\
Schlaufman, K.~C. \& Casey, A.~R., 2014, ApJ, 797, 13: \textit{The Best and Brightest Metal-poor Stars}\\
Keller, S., Bessell, M., Frebel, A., Casey, A.~R., et al., 2014, Nature, 506, 463: \textit{A single low-energy, iron-poor supernova as the source of metals in the star SMSS J031300.36-670839.3}\\
Howes, L., Asplund, M., Casey, A.~R., 2014, MNRAS, 445, 4241: \textit{The Gaia-ESO Survey: the most metal-poor stars in the Galactic bulge}\\
Ness, M., et al., 2014, MNRAS, 445, 2994: \textit{NGC 6522: a typical globular cluster in the Galactic bulge without signatures of rapidly rotating Population III stars}\\
Ness, M., et al., 2014, ApJ, 787, 19: \textit{Young Stars in an Old Bulge: A Natural Outcome of Internal Evolution in the Milky Way}\\
Ness, M., et al., 2013, MNRAS, 432, 2092: \textit{ARGOS - IV. The kinematics of the Milky Way bulge}\\
Ness, M., et al., 2013, MNRAS, 430, 836: \textit{ARGOS - III. Stellar populations in the Galactic bulge of the Milky Way}\\
...
% given in this list. INCLUDE ONLY TARGETS REQUESTED FOR P97 
% (except for runs outside P97, e.g. for VLT-XMM and Monitoring proposals).
%
...
\UnsuitableTimes{A}{15-jul-16}{18-jul-16}{Insert explanation of unsuitable time here.}
\UnsuitableTimes{B}{15-jul-16}{18-jul-16}{Insert explanation of unsuitable time here.}
\UnsuitableTimes{C}{20-jul-16}{23-jul-16}{Insert explanation of unsuitable time here.}
...
\TimeCritical{A}{12-may-16}{14-may-16}{Insert reason for time-critical observations.}
\TimeCritical{D}{1-may-16}{2-may-16}{Insert reason for time-critical observations.}
\TimeCritical{D}{17-may-16}{18-may-16}{Insert reason for time-critical observations.}
\TimeCritical{D}{23-may-16}{24-may-16}{Insert reason for time-critical observations.}
...
%     J7.9, PAH1, J8.9, B8.7, ArIII, J9.8, SIV_1, B9.7, SIV, B10.7,
%    SIV_2, PAH2, B11.7, PAH2_2, J12.2, NeII_1, B12.4, NeII, NeII_2, Q1, Q2, Q3 
%
...
% This parameter is NOT checked at the pdfLaTeX compilation.
%
% The available baselines for Period 97 are shown below.
